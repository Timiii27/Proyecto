...
<?php 
  ...
  if (!isset($_SESSION['username'])) {
    ...
    if (mysqli_num_rows($resultado_votacion) > 0) {
      ...
      $votacion_query = "INSERT into votacion_quali (usuario,pos1,pos5,pos10,pos15,pos20) 
      values ('$_SESSION[username]','$posicion1','$posicion2','$posicion3','$posicion4','$posicion5')";
      $resultado_votacion = mysqli_query($db, $votacion_query);
    }
